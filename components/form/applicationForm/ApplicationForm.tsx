...
const ApplicationForm = ({
  ...
  const form = useForm<CreateApplicationType>({
    ...
    defaultValues: {
      ...
      platformServiceCategoryId:
        applicationData?.platformServiceCategoryId || "",
      platformServiceSubCategoryId:
        applicationData?.platformServiceSubCategoryId || "",
      platformServiceCategoryPackageId:
        applicationData?.platformServiceCategoryPackageId || "",
      ...
      countryOfBirthOther:
        applicationData?.serviceFields?.countryOfBirthOther || "",
      ...
      citizenshipCountry:
        applicationData?.serviceFields?.citizenshipCountry || "",
      citizenshipCountryOther:
        applicationData?.serviceFields?.citizenshipCountryOther || "",
      citizenshipAcquiredBy:
        applicationData?.serviceFields?.citizenshipAcquiredBy || "",
      previousCitizenship:
        applicationData?.serviceFields?.previousCitizenship || "",
      previousCitizenshipOther:
        applicationData?.serviceFields?.previousCitizenshipOther || "",

      // Passport Details fields
      passportNumber: applicationData?.serviceFields?.passportNumber || "",
      passportIssuingAuthority:
        applicationData?.serviceFields?.passportIssuingAuthority || "",
      passportIssueDate:
        applicationData?.serviceFields?.passportIssueDate || "",
      passportExpiryDate:
        applicationData?.serviceFields?.passportExpiryDate || "",
      holdsOtherPassport:
        applicationData?.serviceFields?.holdsOtherPassport || "",
      otherPassportNumber:
        applicationData?.serviceFields?.otherPassportNumber || "",
      otherPassportIssuingAuthority:
        applicationData?.serviceFields?.otherPassportIssuingAuthority || "",
      otherPassportIssueDate:
        applicationData?.serviceFields?.otherPassportIssueDate || "",
      otherPassportExpiryDate:
        applicationData?.serviceFields?.otherPassportExpiryDate || "",
      ...
      isPermanentAddress:
        applicationData?.serviceFields?.isPermanentAddress || "",
      ...
      fatherBirthCountry:
        applicationData?.serviceFields?.fatherBirthCountry || "",
      fatherCitizenship:
        applicationData?.serviceFields?.fatherCitizenship || "",
      fatherPrevCitizenship:
        applicationData?.serviceFields?.fatherPrevCitizenship || "",
      ...
      motherBirthCountry:
        applicationData?.serviceFields?.motherBirthCountry || "",
      motherCitizenship:
        applicationData?.serviceFields?.motherCitizenship || "",
      motherPrevCitizenship:
        applicationData?.serviceFields?.motherPrevCitizenship || "",
      maritalStatus: applicationData?.serviceFields?.maritalStatus || "",
      spouseName: applicationData?.serviceFields?.spouseName || "",
      spouseCitizenship:
        applicationData?.serviceFields?.spouseCitizenship || "",
      spousePrevCitizenship:
        applicationData?.serviceFields?.spousePrevCitizenship || "",
      ...
      spouseBirthCountry:
        applicationData?.serviceFields?.spouseBirthCountry || "",
      grandparentsPakistan:
        applicationData?.serviceFields?.grandparentsPakistan || "",
      ...
      previousOccupation:
        applicationData?.serviceFields?.previousOccupation || "",
      militaryService: applicationData?.serviceFields?.militaryService || "",
      militaryCountryBranch:
        applicationData?.serviceFields?.militaryCountryBranch || "",
      militarySpecialization:
        applicationData?.serviceFields?.militarySpecialization || "",
      militaryHighestRank:
        applicationData?.serviceFields?.militaryHighestRank || "",
      ...
      prevVisaIssuedDate:
        applicationData?.serviceFields?.prevVisaIssuedDate || "",
      visaRefused: applicationData?.serviceFields?.visaRefused || "",
      visaRefusalDetails:
        applicationData?.serviceFields?.visaRefusalDetails || "",
      countriesVisited10Years:
        applicationData?.serviceFields?.countriesVisited10Years || "",
      ...
      refusedEntryDeported:
        applicationData?.serviceFields?.refusedEntryDeported || "",
      refusedEntryDetails:
        applicationData?.serviceFields?.refusedEntryDetails || "",
          ...
          platformServices: [
            {
              ...
              platformServiceCategoryPackageId:
                values.platformServiceCategoryPackageId,
              platformServiceCategoryPackageAddonsId:
  ...
  const handleApplicationStatusChange = handleAsync(
  ...
  useEffect(() => {
    if (Object.keys(applicationData || {}).length) {
      ...
      console.log(
        ...
        applicationData?.platformServices?.[0]
          ?.platformServiceCategoryPackageAddonsId
      );
      form.reset({
        toCountryId: applicationData?.toCountryId || "",
        ...
        platformServiceCategoryId:
          applicationData?.platformServiceCategoryId || "",
        platformServiceSubCategoryId:
          applicationData?.platformServiceSubCategoryId || null,
        platformServiceCategoryPackageId:
          applicationData?.platformServiceCategoryPackageId || "",
        platformServiceCategoryPackageAddonsId:
          applicationData?.platformServiceCategoryPackageAddonsId || [],
  ...
  return (
    <Form {...form}>
      <form
        onSubmit={form.handleSubmit(isEdit ? onEditSubmit : onSubmit)}
        ...
        <div className="space-y-6">
          ...
          <div className="p-4 border rounded-lg grid sm:grid-cols-2 gap-4">
            ...
            <ComboSelect
              ...
              enable={
                isEdit ? false : form.watch("platformServiceId") ? true : false
              }
              apiPath={
